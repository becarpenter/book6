...
- Topology hiding, which is sometimes cited as an argument for NAT, is
  discussed in
  \[[4. Topology obfuscation](../04.%20Security/Topology%20obfuscation.md)\].
...
### [<ins>Previous</ins>](Multi-prefix%20operation.md) [<ins>Next</ins>](Energy%20consumption.md) [<ins>Top</ins>](06.%20Management%20and%20Operations.md)
