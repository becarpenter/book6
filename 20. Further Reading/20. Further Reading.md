...
`https://www.rfc-editor.org/info/rfcNNNNN`, where `NNNNN` is the RFC
...
- There is a free, advertising-free knowledge base at [https://kb.isp6.net](https://kb.isp6.net) - IPv6 fundamentals, BYOIP guides for AWS/Azure/GCP, and reference architectures, written for engineers deploying IPv6 in practice as well as the managers who must sponsor it.

- [Inessential IPv6](https://docs.google.com/document/d/1WohukYWdlFcEaSm-SQtX5Zgrkr-FZiZnfhlvoFi5Bl0/edit).
  This project overlaps in intent with book6. (Last update seen in 2023.)
