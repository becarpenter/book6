...
June, China had 834 million active IPv6 users, i.e., \textbf{75.29\%} of
Chinese Internet users. 66\% of traffic on mobile networks ran over
IPv6, vs 28.32\% on fixed networks.
...
\subsubsection{Standards Track (268
RFCs)}\label{standards-track-268-rfcs}
