...
\subsubsection{\texorpdfstring{\hyperref[management-and-operations]{Next}
...
{[}\hyperref[ipv6-primary-differences-from-ipv4]{3. IPv6 primary
differences from IPv4}{]}, IPv6 does not allow intermediate routers to
fragment packets. Instead, IPv6 pushes the responsibility of
...
use PMTUD \href{https://www.rfc-editor.org/info/rfc7690}{RFC7690} to
ensure that packets are sized appropriately for the smallest MTU along
the path. The sender fragments packets if necessary before sending them.
This require additional computation on the sender to fragment packets
but there has been no significant performance implication reported.
...
\href{https://www.rfc-editor.org/info/rfc7690}{RFC7690}. If a jumbo
frame exceeds the MTU of any network hop, the sender is responsible for
...
\href{https://www.rfc-editor.org/info/rfc2675}{RFC2675} allows packets
...
intermediate fragmentation. However, it is very little used.
...
\hyperref[deployment-status]{Top}}{Previous Next Top}}\label{previous-next-top-34}
...
\hyperref[further-reading]{Next}
\hyperref[troubleshooting]{Top}}{Previous Next Top}}\label{previous-next-top-37}
...
be misleading as well as out of date.
...
\subsubsection{Informational (188 RFCs)}\label{informational-188-rfcs}
...
\hyperref[chapter-template]{Top}}{Previous Next Top}}\label{previous-next-top-38}
