...
those three methods of co-existence in more detail. A final section
lists some mechanisms that are no longer recommended.
...
As networks migrate away from IPv6 and into an IPv6-only environment,
...
- IPv4 only enclaves Areas where IPv6 simply is not possible or
